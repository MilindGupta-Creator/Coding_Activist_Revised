  ...
  return (
    <div className="relative pt-32 pb-20 lg:pt-24 lg:pb-28 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-600/20 rounded-full blur-[100px]" />
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-white mb-6 leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-300 via-brand-500 to-accent-500">
                Architect Scalable Systems.
              </span>
            </h1>
            <p className="text-lg md:text-xl text-slate-400 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              The only playbook you need to master <strong>Design-to-Code</strong>, <strong>Micro-frontends</strong>, and <strong>Distributed State</strong>. Transform from a component builder to a Staff Engineer.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10">
              <button 
                onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })}
                className="px-8 py-4 bg-brand-600 hover:bg-brand-500 text-white rounded-xl font-semibold text-lg transition-all shadow-xl shadow-brand-500/20 hover:shadow-brand-500/40 hover:-translate-y-1"
              >
                Get the Ebook ($29)
              </button>
              <button 
                onClick={() => document.getElementById('preview')?.scrollIntoView({ behavior: 'smooth' })}
                className="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-xl font-semibold text-lg transition-all"
              >
                Test Your Knowledge
              </button>
            </div>
            ...
            <div className="mt-8 p-6 bg-slate-800/40 backdrop-blur-md border border-slate-700/50 rounded-xl max-w-lg mx-auto lg:mx-0 shadow-lg animate-fade-in hover:border-brand-500/30 transition-colors group cursor-default">
              <div className="flex items-center justify-between mb-3">
                 <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                    <span className="text-xs font-bold text-slate-300 uppercase tracking-wider">L6 Interview Question</span>
                 </div>
                 <span className="text-[10px] font-mono bg-slate-700/50 text-slate-400 px-2 py-1 rounded border border-slate-600/50 group-hover:border-brand-500/30 group-hover:text-brand-400 transition-colors">Staff Level • System Design</span>
              </div>
              <p className="text-slate-100 font-medium text-lg mb-4 leading-relaxed">
                "Design a resilient <span className="text-brand-300">server-driven UI</span> framework for a high-traffic e-commerce app that handles partial hydration and A/B testing at the edge."
              </p>
          ...
          <div className="flex-1 flex justify-center perspective-[1500px] z-10" ref={bookRef}>
            <div className={`transition-all duration-1000 ease-[cubic-bezier(0.34,1.56,0.64,1)] transform ${
              ...
              <div className="relative group animate-float">
                ...
                <div className="relative w-80 sm:w-96 rounded-xl overflow-hidden shadow-2xl border border-white/10 bg-slate-900/95 backdrop-blur-xl transform transition-transform duration-500 group-hover:scale-[1.02] group-hover:-translate-y-1">
                  ...
                  <div className="bg-[#1e293b] px-4 py-3 flex items-center justify-between border-b border-slate-700/50">
                    ...
                    <div className="text-[10px] font-mono text-slate-400 bg-slate-800/50 px-3 py-1 rounded-full border border-slate-700/50 flex items-center gap-2">
